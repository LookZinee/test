    ...
    <div class="span4 offset4 dialog">
        <div class="block">
            ...
            <div class="block-body">
                <form action="teaddQue.action" method="post">
                	${meg }
                	<input type="hidden" name="question.student.id" value="${currentStudent.id }">
                	 <label>选择科目</label>
                    ...
                    <label>问题</label>
                    <input type="text" name="question.title" class="span12">
                    <label>A选项</label>
                    <input type="text" name="question.optiona" id="pwdid" class="span12">
                     <label>B选项</label>
                    <input type="text" name="question.optionb" id="pwdid" class="span12">
                     <label>C选项</label>
                    <input type="text" name="question.optionc" id="pwdid" class="span12">
                     <label>D选项</label>
                    <input type="text" name="question.optiond" id="pwdid" class="span12">
                     <label>答案</label>
                    <input type="text" name="question.answer" id="pwdid" class="span12">
