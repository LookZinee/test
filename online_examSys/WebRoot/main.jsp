    ...
    <div class="navbar">
        <div class="navbar-inner">
            <div class="container-fluid">
                <ul class="nav pull-right">
                    ...
                    <li id="fat-menu" class="dropdown">
                        <a href="#" id="drop3" role="button" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="icon-user"></i>${currentStudent.name }
                ...
                <a class="brand" href="index.html"><span class="first">北京尚学堂</span> <span class="second">20150526班</span></a>
            </div>
        </div>
    </div>
                ...
                <div class="sidebar-nav">
                  <c:choose>
                  	<c:when test="${currentStudent.role==1 }">
                        ...
                        <li><a href="index.html">科目管理</a></li>
                        <li ><a href="users.html">题库管理</a></li>
                        <li ><a href="user.html">学生管理</a></li>
                        <li ><a href="gallery.html">考试权重设置</a></li>
                  		 </ul>
                  	</c:when>
                  	...
                  	<c:otherwise>
	                  	...
	                  	<li ><a href="sign-in.html">考试</a></li>
